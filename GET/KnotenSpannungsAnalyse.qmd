...
Unter Verwendung der Knotenregel, der Maschenregel und dem Ohmschen Gesetz werden für Gleichungen aufgestellt. Es entsteht ein lineares Gleichungssystem, das gelöst werden kann.
...
UR = MySymbol('U_R',description='Spannung am Widerstand',unit='V')
...
**5. Ohmsche Gesetz für die Widerstände anschreiben**   
...
U1 = MySymbol('U1',description='Spannung an R1',unit=u.V)
U2 = MySymbol('U2',description='Spannung an R2',unit=u.V)
U3 = MySymbol('U3',description='Spannung an R3',unit=u.V)
...
QBookHelpers.print_description([R1,R2,R3,Uq1,Uq2,U1,U2,U3,I1,I2,I])
...
Pass, es gibt 9 Gleichungen und 9 Unbekannte. 
...
UR1 = MySymbol('U_R1',description='Spannung an R1',unit=u.V)
UR2 = MySymbol('U_R2',description='Spannung an R2',unit=u.V)
UR3 = MySymbol('U_R3',description='Spannung an R3',unit=u.V)
UR4 = MySymbol('U_R4',description='Spannung an R4',unit=u.V)
UR5 = MySymbol('U_R5',description='Spannung an R5',unit=u.V)
I1 = MySymbol('I1',description='Strom durch R1',unit=u.A)
I2 = MySymbol('I2',description='Strom durch R2',unit=u.A)
I3 = MySymbol('I3',description='Strom durch R3',unit=u.A)
