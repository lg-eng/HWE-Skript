...
* Application Notes der Hersteller lesen und verstehen
...
Zur Überprüfung wird aus den Gleichungen die Wahrheitstabellen erstellt und mit der oben definierten Wahrheitstabellen verglichen.  
...
Diese Pegelanpassung lässt sich einfach mit OPV's realisieren. Durch die Slew-Rate der OPV's entstehen dabei aber deutliche Verluste bei jedem Schaltvorgang. Für die Funktion und Simulation wird trotz der Nachteile diese Lösung gewählt. Wichtig ist dabei, dass die OPV's Ausgangsspannungen deutlich unter bzw. deutlich über der Threshholdspannung der Mosfets ausgeben.  

![Pegelanpassung mit OPV ](Grafiken/Hbruecke/OPV-Schaltung.png){#fig-OPV-Schaltung}

### Umsetzung in der Praxis
Wird eine H-Brücke in der Paxis verwendet wird eine integrierte oder teilintegrierte Lösung, sogenannte H-Brückentreiber, gewählt. 
