...
$S_1, S_2, S_ 3$ und $S_4$ stellen dabei Potentiale dar. Zur erinnerung, ein MOSFET schaltet wenn die Spannungs zwischen Gate und Source, $U_{GS}$, die Threshold-Spannung $U_{GS,Threshold}$ überschreitet. In Bild @fig-H-BrueckeMS sind alle Schalter offen. Da es sich um N-Kanal Selbstsperrende MOSFET handelt müssen, für diesen Zustand, alle Potentiale, $S_1$ bis $S_4$, $0 \ \mathrm{V}$ sein.
