...
#| code-fold: true
#| echo: false
#| label: fig-BJT_Gegen_Sim1
#| fig-cap: "Bipolartransistoren in Gegentakt, Simulationsergebnisse"

import pandas as pd
import plotly.express as px

df = pd.read_csv('Grafiken/01_Transient Analysis.csv',sep=';',decimal=',')
fig = px.line(df, x="time", y=['v(uin)','v(uout)'], title=None)
