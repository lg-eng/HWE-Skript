...
Der maximale Laststrom $I_{Lmax}$ wurde in @sec-LV_Vorspannen bestimmt, indem der maximale Strom der Vorspannungsquelle im Betrieb mittels Simulation bestimmt wurde und mit einer gewissen Sicherheit aufgerundet wurde.
