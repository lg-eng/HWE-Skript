...
Der Arbeitspunkt muss möglichst mittig in einem linearen Teilstück des JFET liegen. Eine Steuerspannung zwischen 3 und 5 Volt ist ideal. Um diese Spannung $U_{st}$ zu aus dem Ausgangssignal $U_{out}$ zu gewinnen wird ein Spannungsteiler, realisiert mit einem Potentiometer, und ein Einweggleichrichter verwendet.  
